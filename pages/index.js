...
import rakib from "../public/avatar.png";
...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Rakibulinux</title>
        <meta name="description" content="Generated by Rakibulinux" />
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            <h2 className="text-transparent bg-clip-text  bg-gradient-to-r from-cyan-400 to-sky-600 text-5xl py-2 text-cyan-600 font-medium dark:text-cyan-400 dark:to-sky-600 md:text-6xl">
            ...
            <div className="mx-auto bg-gradient-to-b from-cyan-500 rounded-full w-80 h-80 relative overflow-hidden mt-20 md:h-96 md:w-96">
              <Image src={rakib} layout="fill" objectFit="cover" alt="no" />
            </div>
          </div>
        </section>
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              ...
              development, deployment and teaching.
            </p>
          </div>
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10  dark:bg-white flex-1">
              <div className="flex items-center justify-center">
                <Image src={design} width={100} height={100} alt="rakib" />
              </div>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              <div className="flex items-center justify-center">
                <Image src={code} width={100} height={100} alt="rakib" />
              </div>
              <h3 className="text-lg font-medium pt-8 pb-2 ">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              <div className="flex items-center justify-center">
                <Image src={consulting} width={100} height={100} alt="rakib" />
              </div>
